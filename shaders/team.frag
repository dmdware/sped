...
void main()
{
  ...
  poissonDisk[3] = vec2( 0.34495938, 0.29387760 );
	...
	vec4 texel1 = texture2D(texture0, gl_TexCoord[0].xy);
	...
	//vec4 stexel = texel0;
	vec4 stexel = vec4(texel0.w,texel0.w,texel0.w,1);
	...
	// with specular highlights (adds team colour alpha where there isn't):
