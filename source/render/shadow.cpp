...
void RenderToShadowMap(Matrix projection, Matrix viewmat, Matrix modelmat, Vec3f focus, void (*drawscenedepthfunc)())
{
	...
	glUniformMatrix4fv(g_shader[SHADER_DEPTH].m_slot[SSLOT_MVP], 1, 0, mvp.m_matrix);
...
void RenderToDepthMap(Matrix projection, Matrix viewmat, Matrix modelmat, Vec3f focus, void (*drawscenedepthfunc)())
{
	...
	glUniformMatrix4fv(s->m_slot[SSLOT_PROJECTION], 1, 0, g_lightproj.m_matrix);
	glUniformMatrix4fv(s->m_slot[SSLOT_MODELMAT], 1, 0, modelmat.m_matrix);
	glUniformMatrix4fv(s->m_slot[SSLOT_VIEWMAT], 1, 0, g_lightview.m_matrix);
	glUniform1f(s->m_slot[SSLOT_MIND], MIN_DISTANCE);
	glUniform1f(s->m_slot[SSLOT_MAXD], MAX_DISTANCE);
	//glUniform4f(g_shader[SHADER_MODEL].m_slot[SSLOT_COLOR], 1, 1, 1, 1);
	//glEnableVertexAttribArray(g_shader[SHADER_DEPTH].m_slot[SSLOT_POSITION]);
	//glEnableVertexAttribArray(g_shader[SHADER_DEPTH].m_slot[SSLOT_TEXCOORD0]);
